...
public class Main {
    ...
    private static void outputTeacherError(String message, StackTraceElement[] stackTrace) {
        // Logic to display error specifically for teachers (e.g., more technical details)
        System.err.println("\n--- Teacher Error ---");
