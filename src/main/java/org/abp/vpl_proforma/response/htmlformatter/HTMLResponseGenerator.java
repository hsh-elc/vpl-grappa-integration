...
public class HTMLResponseGenerator {
    ...
    private static final String STUDENT_OUTPUT_HEADER_START = "<|--";
    private static final String STUDENT_OUTPUT_HEADER_END = "--|>";
    private static final String OUTPUT_BASE64_PREFIX = "data:text/html;base64,";
    private static final String OUTPUT_GRADE_PREFIX = "Grade :=>>";
    ...
    public HTMLResponseGenerator(SeparateTestFeedbackType separateTestFeedback, CombineNode gradingStructure, double scaleFactor) {
    ...
    public void generateSeparateTestFeedbackDocuments() {
        String studentHtml = buildReportHtml(false); // Generate student view
        String teacherHtml = buildReportHtml(true);  // Generate teacher view
     ...
     */
    private void outputReport(String studentHtml, String teacherHtml, double grade) {
